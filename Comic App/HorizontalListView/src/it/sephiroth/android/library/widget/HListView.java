...
public class HListView extends AbsHListView {
	...
	public HListView(Context context, AttributeSet attrs, int defStyle) {
		...
		CharSequence[] entries = a
				.getTextArray(R.styleable.HListView_android_entries);
		if (entries != null) {
		...
		final Drawable osHeader = a
				.getDrawable(R.styleable.HListView_overScrollHeader);
		if (osHeader != null) {
			setOverscrollHeader(osHeader);
		}

		final Drawable osFooter = a
				.getDrawable(R.styleable.HListView_overScrollFooter);
		if (osFooter != null) {
		...
		mHeaderDividersEnabled = a.getBoolean(
				R.styleable.HListView_headerDividersEnabled, true);
		mFooterDividersEnabled = a.getBoolean(
				R.styleable.HListView_footerDividersEnabled, true);
		mMeasureWithChild = a.getInteger(
				R.styleable.HListView_measureWithChild, -1);
